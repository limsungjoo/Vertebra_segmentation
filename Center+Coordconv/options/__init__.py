...
def parse_option(print_option=True):    
    ...
    # Data Directory
    p.add_argument('--data_root', default= "/home/vfuser/sungjoo/data/dongsam_test/sam_mask/*", type=str, help='root directory of dataset files.')
    ...
    p.add_argument('--resume', default='/home/vfuser/sungjoo/Center+Coordconv/exp/epoch_0066_iou_0.0000_loss_0.35822001.pth', type=str, help="pth file path to resume")
    ...
    # Output directory
    p.add_argument('--exp', default='/home/vfuser/sungjoo/Center+Coordconv/exp/fine-tuning(sam,dong)', type=str, help='checkpoint dir.')
