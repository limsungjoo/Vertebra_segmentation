...
def create_model(opt):
    ...
    if opt.resume:
        if os.path.isfile('/home/vfuser/sungjoo/Centroid-Unet/model/epoch_0064_iou_0.2131_loss_0.63158804.pth'):
            pretrained_dict = torch.load('/home/vfuser/sungjoo/Centroid-Unet/model/epoch_0064_iou_0.2131_loss_0.63158804.pth', map_location=torch.device('cuda'))
