...
def parse_option(print_option=True):    
    ...
    # Data Directory
    p.add_argument('--data_root', default= "/home/vfuser/sungjoo/data/new_dataset/center/*", type=str, help='root directory of dataset files.')
    ...
    p.add_argument('--resume', default='d', type=str, help="pth file path to resume")
    ...
    p.add_argument('--gpu_id', default="0,1", type=str)

    # Output directory
    p.add_argument('--exp', default='./Centroid-Unet/model', type=str, help='checkpoint dir.')
