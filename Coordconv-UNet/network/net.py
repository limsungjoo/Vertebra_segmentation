...
vgg_model_1 = models.vgg16(pretrained=False).features[:-1]

vgg_model_2 = models.vgg16(pretrained=False).features[:16]
...
if __name__ == "__main__":
    ...
    print(model.module)
    print("----------------------")
    print(models.vgg16(pretrained=False).features[:-1][:16])
    print("----------------------")
    print(models.vgg16(pretrained=False).features[:-1][:23])
