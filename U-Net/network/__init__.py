...
def create_model(opt):
    ...
    if opt.resume:
        if os.path.isfile('/home/vfuser/sungjoo/Resize_model/exp/epoch_0046_iou_0.8282_loss_0.09410447.pth'):
            pretrained_dict = torch.load('/home/vfuser/sungjoo/Resize_model/exp/epoch_0046_iou_0.8282_loss_0.09410447.pth', map_location=torch.device('cuda'))
